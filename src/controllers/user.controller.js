...
const refreshAccessToken=asyncHandler(async(req,res)=>{
    ...
    try {
        ...
        const {accessToken,refreshToken}=await generateAccesandRefreshTokens(user._id)
        return res.status(200).cookie("accessToken",accessToken,options).cookie("refreshToken",refreshToken,options).json(new ApiResponse(200,{accessToken,refreshToken},"Access Token is refreshed"))
    } catch (error) {
